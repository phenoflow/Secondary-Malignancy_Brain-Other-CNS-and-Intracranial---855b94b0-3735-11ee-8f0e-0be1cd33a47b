...
steps:
  ...
  secondary-malignancy_brain-other-cns-and-intracranial-neoplasm---secondary:
    run: secondary-malignancy_brain-other-cns-and-intracranial-neoplasm---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: secondary-malignancy_brain-other-cns-and-intracranial-neoplasm---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
